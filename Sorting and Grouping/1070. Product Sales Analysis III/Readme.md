...
| Product | First Year | Quantity | Price |
|---------|-----------:|---------:|------:|
| **100** | 2008 | 10 | 5000 |
| **200** | 2011 | 15 | 9000 |

- **Product 100** was first sold in **2008**, so return its **quantity (10)** and **price (5000)**.
- **Product 200** was first sold in **2011**, so return its **quantity (15)** and **price (9000)**.
